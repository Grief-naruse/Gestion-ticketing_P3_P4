...
foreach ($tickets as $t) {
    if ($t['status'] === 'status-to_validate' || $t['status'] === 'status-new')
        $nbToValidate++;
}
...
<body>
    ...
    <main class="content">
        <header>
            ...
            <div class="actions">
                <a href="project-new.php" class="btn" style="background-color: #7f8c8d; margin-right: 10px;">+ Nouveau
                    Projet</a>
        ...
        <section class="grid-4">
            <div class="card">
                <h3>Tickets Total</h3>
                <p class="animate-number" style="font-size: 2rem; font-weight: bold; color: var(--accent-color);">
                    <?php echo $nbTickets; ?></p>
            </div>
            <div class="card">
                <h3>À valider (Client)</h3>
                <p class="animate-number" style="font-size: 2rem; font-weight: bold; color: var(--warning-color);">
                    <?php echo $nbToValidate; ?></p>
            </div>
            <div class="card">
                <h3>Projets actifs</h3>
                <p class="animate-number" style="font-size: 2rem; font-weight: bold; color: #9b59b6;">
                    <?php echo $nbProjets; ?></p>
            </div>
            <div class="card">
                <h3>Heures consommées</h3>
                <p class="animate-number" style="font-size: 2rem; font-weight: bold;"><?php echo $totalHoursReal; ?>h
                </p>
            </div>
        </section>
