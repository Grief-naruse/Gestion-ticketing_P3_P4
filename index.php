...
<body class="login-page">
    <div class="card" style="width: 100%; max-width: 400px;">
        ...
        <form id="loginForm" action="dashboard.php">
            ...
            <div class="form-group">
                ...
                <div style="text-align: right; margin-top: 5px;">
                    <a href="forgot-password.php" style="font-size: 0.8rem; color: #666; text-decoration: none;">Mot de
                        passe oublié ?</a>
                </div>
            </div>
        ...
        <div style="text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #eee;">
            ...
            <a href="register.php" style="color: var(--accent-color); font-weight: bold; text-decoration: none;">Créer
                un compte</a>
        </div>
    </div>
