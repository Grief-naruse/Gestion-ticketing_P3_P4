...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Cherche tous les liens qui contiennent "index.php" (la page de login)
    const logoutLinks = document.querySelectorAll('a[href="index.php"]');
    ...
    handleSimpleForm('loginForm', "👋 Connexion réussie...", "dashboard.php");
    ...
    const projectForm = document.getElementById('projectForm'); // ID à ajouter sur project-new.php
    ...
    const passwordForm = document.getElementById('passwordForm'); // Sur profile.php
    ...
    validatePasswords(registerForm, 'index.php');
