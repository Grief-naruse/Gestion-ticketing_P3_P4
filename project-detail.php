    ...
    <main class="content">
        ...
        <header style="margin-top: 15px; display: flex; justify-content: space-between; align-items: flex-start;">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <form action="project-close.php" method="POST"
        ...
        <div class="grid-2">
            <div class="card">
                ...
                <div style="background: #eee; height: 15px; border-radius: 10px; margin: 15px 0;">
                    <div
                        style="background: #3498db; width: <?php echo min($percent, 100); ?>%; height: 100%; border-radius: 10px;">
                    </div>
                </div>
                <p><?php echo number_format($used, 2); ?>h / <?php echo number_format($project['hours_total'], 2); ?>h
                </p>
            </div>
            <div class="card">
                    ...
                    <?php foreach ($tickets as $t): ?>
                        <tr>
                            ...
                            <td style="padding: 10px;">
                                <span class="badge type-<?php echo $t['type']; ?>">
                                    <?php echo $typeLabels[$t['type']] ?? $t['type']; ?>
                                </span>
                            </td>

                            <td style="padding: 10px;">
                                <span class="badge status-<?php echo $t['status']; ?>">
                                    <?php echo $statusLabels[$t['status']] ?? $t['status']; ?>
                                </span>
                            </td>

                            <td style="padding: 10px;"><a href="ticket-detail.php?id=<?php echo $t['id']; ?>"
                                    style="color: #3498db;">Voir</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
