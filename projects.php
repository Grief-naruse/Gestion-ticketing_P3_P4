            ...
            <section class="grid-2">
                <?php foreach ($projects as $project): ?>
                    ...
                    <article class="card">
                        ...
                        <p><strong>Contrat :</strong> <span
                                class="badge"><?php echo htmlspecialchars($project['type']); ?></span></p>
                        ...
                        <p>Heures consommées : <strong><?php echo number_format($used, 2); ?>h /
                                <?php echo $project['hours_total']; ?>h</strong></p>

                        <div style="background: #eee; height: 10px; border-radius: 5px; margin-top: 5px;">
                            <div
                                style="background: <?php echo $barColor; ?>; width: <?php echo min($percent, 100); ?>%; height: 100%; border-radius: 5px;">
                            </div>
                        </div>

                        <div style="margin-top: 15px;">
                            <a href="project-detail.php?id=<?php echo $project['id']; ?>" class="btn"
                                style="font-size: 0.8rem; background-color: #7f8c8d;">Détails du projet</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            </section>
