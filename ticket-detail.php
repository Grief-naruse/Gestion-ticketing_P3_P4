        ...
        <div class="grid-2">
                    ...
                    <form action="add-time.php" method="POST" style="margin-top: 15px;">
                        ...
                        <div class="grid-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="duration" step="0.25" min="0.25" placeholder="ex: 1.5"
                                    required>
                            </div>
                            <div class="form-group">
            ...
            <div>
                <div class="card">
                    ...
                    <p><strong>Assigné à :</strong> <span class="badge"
                            style="background:#eee; color:#333; min-width:auto;"><?php echo htmlspecialchars($ticket['assigned_name'] ?? 'Non assigné'); ?></span>
                    </p>
                    <p><strong>Créé par :</strong> <?php echo htmlspecialchars($ticket['author_name'] ?? 'Système'); ?>
                    </p>
                    <p><strong>Date de création :</strong> <span id="ticket-creation-date"
                            data-created="<?php echo $ticket['created_at']; ?>"><?php echo date('d/m/Y H:i', strtotime($ticket['created_at'])); ?></span>
                    </p>
                    ...
                    <div
                        style="text-align: center; margin-top: 15px; padding: 10px; background: #f9f9f9; border-radius: 4px;">
                        <p style="font-size: 0.8rem; color: #7f8c8d; text-transform: uppercase;">Ouvert depuis</p>
                        <div id="live-timer" style="font-family: monospace; font-size: 1.2rem; font-weight: bold;">00h
                            00m 00s</div>
                    </div>
                </div>
                ...
                <div class="card" style="margin-top: 20px;">
                    ...
                    <form action="ticket-update.php" method="POST" style="margin-top: 10px;">
                        ...
                        <button type="submit" class="btn"
                            style="width: 100%; background-color: var(--accent-color);">Mettre à jour</button>
                    </form>
                </div>
            </div>
        </div>
